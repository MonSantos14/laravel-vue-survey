<template>
  <PageComponent title="Dashboard">
    ...
    >
      ...
      >
        <h3 class="text-2xt font-semibold">Total Surveys</h3>
        <div
      ...
      >
        <h3 class="text-2xt font-semibold">Total Answers</h3>
        <div
          class="text-8xl font-semibold flex-1 flex items-center justify-center"
        >
          {{ data.totalAnswers }}
      ...
      >
        <h3 class="text-2xt font-semibold">Latest Survey</h3>
        <img
        ...
        <div class="flex justify-between text-sm mb-1">
          <div>Expire Date:</div>
          <div v-if="data.latestSurvey.expire_date">
